...
public class TestControllerTest {
    ...
    public void givenTestUri_whenMockMVC_thenVerifyResponse() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(get("/api/test")).andDo(print()).andExpect(status().isOk())
                .andExpect(jsonPath("$.message").value("Available API!")).andReturn();
    ...
    public void givenExceptionUri_whenMockMVC_thenVerifyError() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(get("/api/test/exception")).andDo(print())
