package com.emergya.sss3E.persistence.configuration;

import com.emergya.sss3E.persistence.props.JdbcPropsValues;
...
@ComponentScan({ "com.emergya.sss3E.persistence" })
@EnableJpaRepositories(basePackages = "com.emergya.sss3E.persistence.repository")
