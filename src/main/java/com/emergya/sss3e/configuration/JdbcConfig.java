...
import com.emergya.sss3e.commons.props.JdbcPropsValues;
...
@EnableJpaRepositories(basePackages = "com.emergya.sss3e.repository")
@EnableTransactionManagement
public class JdbcConfig {

    @Autowired
    JdbcPropsValues jdbcPropsValues;
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource datasource) {
        ...
        entityManagerFactory.setPackagesToScan(new String[] { "com.emergya.sss3e.repository.model" });
